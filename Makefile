...
imx31_mario_config :    unconfig
	@$(MKCONFIG) $(@:_config=) arm arm1136 imx31_mario NULL mx31

imx35_luigi_config :    unconfig
	@$(MKCONFIG) $(@:_config=) arm arm1136 imx35_luigi NULL mx35
